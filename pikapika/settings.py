...
DATABASES = {
    'default': {
        ...
        'NAME': 'pikapika',                      # Or path to database file if using sqlite3.
        'USER': 'pikapika',                      # Not used with sqlite3.
        'PASSWORD': 'FF7sVbByuzT8M9cgd5kmxePMXjGUzfaw',                  # Not used with sqlite3.
...
STATIC_ROOT = os.path.join(_PROJECT_ROOT, 'static/')
...
WSGI_APPLICATION = 'pikapika.wsgi.application'
